<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DealerUpdateProfile.aspx.cs" Inherits="Dealer_DealerUpdateRecord" %>
    ...
    <div class="container">
      ...
      <form class="form-signin"  runat="server">
        ...
        <div class="login-wrap">
            ...
            <asp:Button ID="btn_updateDealer" runat="server" CssClass="btn btn-lg btn-login btn-block" Text="Update" ValidationGroup="u_pd" OnClick="btn_updateDealer_Click" ></asp:Button>
